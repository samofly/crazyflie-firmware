...
#define __STM32F10X_STDPERIPH_VERSION_SUB1                                     \
  (0x01) /*!< [15:8]  STM32F10x Standard Peripheral Library sub1 version */
#define __STM32F10X_STDPERIPH_VERSION_SUB2                                     \
  (0x02) /*!< [7:0]  STM32F10x Standard Peripheral Library sub2 version */
...
#define PERIPH_BB_BASE                                                         \
  ((uint32_t)0x42000000) /*!< Peripheral base address in the alias region */
#define SRAM_BB_BASE                                                           \
  ((uint32_t)0x22000000) /*!< SRAM base address in the alias region */

#define SRAM_BASE                                                              \
  ((uint32_t)0x20000000) /*!< Peripheral base address in the bit-band region   \
                            */
#define PERIPH_BASE                                                            \
  ((uint32_t)0x40000000) /*!< SRAM base address in the bit-band region */
...
#define RCC_APB2RSTR_AFIORST                                                   \
  ((uint16_t)0x0001) /*!< Alternate Function I/O reset */
...
#define RCC_APB2ENR_AFIOEN                                                     \
  ((uint16_t)0x0001) /*!< Alternate Function I/O clock enable */
...
#define RCC_APB2ENR_ADC1EN                                                     \
  ((uint16_t)0x0200) /*!< ADC 1 interface clock enable */
#define RCC_APB2ENR_ADC2EN                                                     \
  ((uint16_t)0x0400) /*!< ADC 2 interface clock enable */
...
#define AFIO_MAPR_PTP_PPS_REMAP                                                \
  ((uint32_t)0x20000000) /*!< PTP_PPS_REMAP bit (Ethernet PTP PPS remapping)   \
                            */
#endif
