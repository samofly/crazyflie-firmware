...
struct xLIST_ITEM {
  ...
  xItemValue; /*< The value being listed.  In most cases this is used to sort
...
typedef struct xLIST {
  ...
  xMiniListItem xListEnd; /*< List item that contains the maximum possible item
...
#define listLIST_IS_EMPTY(pxList)                                              \
  ((portBASE_TYPE)((pxList)->uxNumberOfItems == (unsigned portBASE_TYPE)0))
