...
void vListInitialise(xList *const pxList) {
  ...
  pxList->pxIndex = (xListItem *)&(
      pxList->xListEnd); /*lint !e826 !e740 The mini list structure is used as
  ...
  if (xValueOfInsertion == portMAX_DELAY) {
    ...
    **********************************************************************/
    ...
    for (pxIterator = (xListItem *)&(pxList->xListEnd);
         ...
         pxIterator = pxIterator->pxNext) /*lint !e826 !e740 The mini list
                                             structure is used as the list end
                                             to save RAM.  This is checked and
                                             valid. */
        {
