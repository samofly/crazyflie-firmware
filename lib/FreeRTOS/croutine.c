...
static xList *pxOverflowDelayedCoRoutineList; /*< Points to the delayed
                                                 ...
                                                 tick count. */
static xList xPendingReadyCoRoutineList; /*< Holds co-routines that have been
...
static portTickType xCoRoutineTickCount = 0, xLastTickCount = 0,
                    xPassedTicks = 0;
...
static void prvCheckPendingReadyList(void) {
  ...
  while (listLIST_IS_EMPTY(&xPendingReadyCoRoutineList) == pdFALSE) {
    ...
    {
      pxUnblockedCRCB =
          (corCRCB *)listGET_OWNER_OF_HEAD_ENTRY((&xPendingReadyCoRoutineList));
