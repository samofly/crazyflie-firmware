...
static const volatile unsigned char *const pcInterruptPriorityRegisters =
    (const volatile unsigned char * const)portNVIC_IP_REGISTERS_OFFSET_16;
...
portBASE_TYPE xPortStartScheduler(void) {
...
#if (configASSERT_DEFINED == 1)
  {
    ...
    volatile char *const pcFirstUserPriorityRegister = (volatile char * const)(
