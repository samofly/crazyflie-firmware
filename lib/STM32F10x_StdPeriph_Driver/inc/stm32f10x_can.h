...
typedef struct {
  ...
  uint8_t CAN_SJW; /*!< Specifies the maximum number of time quanta the CAN
                      hardware
...
typedef struct {
  uint16_t CAN_FilterIdHigh; /*!< Specifies the filter identification number
                                ...
                                configuration).
                                  This parameter can be a value between 0x0000
                                and 0xFFFF */
...
typedef struct {
  ...
  uint8_t IDE; /*!< Specifies the type of identifier for the message that will
                  be transmitted.
...
typedef struct {
  ...
  uint8_t FMI; /*!< Specifies the index of the filter the message stored in the
...
#define IS_CAN_ITStatus(IT)                                                    \
  (((IT) == CAN_IT_RQCP0) || ((IT) == CAN_IT_RQCP1) ||                         \
   ((IT) == CAN_IT_RQCP2) || ((IT) == CAN_IT_FF0) || ((IT) == CAN_IT_FOV0) ||  \
   ((IT) == CAN_IT_FF1) || ((IT) == CAN_IT_FOV1) || ((IT) == CAN_IT_EWG) ||    \
   ((IT) == CAN_IT_EPV) || ((IT) == CAN_IT_BOF) || ((IT) == CAN_IT_WKU) ||     \
   ((IT) == CAN_IT_SLK))
/**
  * @}
  */
