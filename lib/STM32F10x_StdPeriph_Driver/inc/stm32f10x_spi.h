...
typedef struct {
  ...
  uint16_t
  SPI_Mode; /*!< Specifies the SPI operating mode.
...
typedef struct {
  ...
  uint16_t
  I2S_Mode; /*!< Specifies the I2S operating mode.
...
#define IS_I2S_AUDIO_FREQ(FREQ)                                                \
  (((FREQ) == I2S_AudioFreq_96k) || ((FREQ) == I2S_AudioFreq_48k) ||           \
   ((FREQ) == I2S_AudioFreq_44k) || ((FREQ) == I2S_AudioFreq_32k) ||           \
   ((FREQ) == I2S_AudioFreq_22k) || ((FREQ) == I2S_AudioFreq_16k) ||           \
   ((FREQ) == I2S_AudioFreq_11k) || ((FREQ) == I2S_AudioFreq_8k) ||            \
