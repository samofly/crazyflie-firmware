 ...
 * ADC1 and ADC2)
  *     @arg ADC_ExternalTrigInjecConv_Ext_IT15_TIM8_CC4: External interrupt
 * line 15 or Timer8
  *                                                       capture compare4 event
 ...
 * software and not
  *                                          by external trigger (for ADC1, ADC2
 * and ADC3)
  * @retval None
  */
