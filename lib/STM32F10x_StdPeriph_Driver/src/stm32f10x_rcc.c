 ...
 * where x:{[4,9], 6_5}
  *   For @b other_STM32_devices, this parameter can be RCC_PLLMul_x where
 * x:[2,16]
  * @retval None
  */
 ...
 * USB
  *                                     clock source
  *     @arg RCC_USBCLKSource_PLLCLK_Div1: PLL clock selected as USB clock
 * source
  * @retval None
  */
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg  RCC_OTGFSCLKSource_PLLVCO_Div3: PLL VCO clock divided by 2
 * selected as USB OTG FS clock source
  *     @arg  RCC_OTGFSCLKSource_PLLVCO_Div2: PLL VCO clock divided by 2
 * selected as USB OTG FS clock source
  * @retval None
  */
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef *RCC_Clocks) {
  ...
  case 0x08: /* PLL used as system clock */
    ...
    if (pllsource == 0x00) { /* HSI oscillator clock divided by 2 selected as
      ...
      if (prediv1source == 0) { /* HSE oscillator clock selected as PREDIV1
                                   clock entry */
