 ...
 * TI1FP1 level.
  *     @arg TIM_EncoderMode_TI12: Counter counts on both TI1FP1 and TI2FP2
 * edges depending
...
/**
  ...
  *     @arg TIM_UpdateSource_Regular: Source of update is the counter
  overflow/underflow
                                       or the setting of UG bit, or an update
  generation
 ...
 * (TRGI) re-initializes
  *                               the counter and triggers an update of the
 * registers.
 ...
 * trigger TRGI.
  *     @arg TIM_SlaveMode_External1: Rising edges of the selected trigger
 ...
 * peripheral.
  ...
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 1 is selected to be connected
 * to IC1.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 1 is selected to be connected
 * to IC2.
  *     @arg TIM_ICSelection_TRC: TIM Input 1 is selected to be connected to
 * TRC.
 ...
 * peripheral.
  ...
  * @param  TIM_ICSelection: specifies the input to be used.
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 2 is selected to be connected
 * to IC2.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 2 is selected to be connected
 * to IC1.
  *     @arg TIM_ICSelection_TRC: TIM Input 2 is selected to be connected to
 * TRC.
  * @param  TIM_ICFilter: Specifies the Input Capture Filter.
  *   This parameter must be a value between 0x00 and 0x0F.
  * @retval None
 ...
 * peripheral.
  ...
  * @param  TIM_ICSelection: specifies the input to be used.
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 3 is selected to be connected
 * to IC3.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 3 is selected to be connected
 * to IC4.
  *     @arg TIM_ICSelection_TRC: TIM Input 3 is selected to be connected to
 * TRC.
  * @param  TIM_ICFilter: Specifies the Input Capture Filter.
  *   This parameter must be a value between 0x00 and 0x0F.
  * @retval None
 ...
 * peripheral.
  ...
  * @param  TIM_ICSelection: specifies the input to be used.
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 4 is selected to be connected
 * to IC4.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 4 is selected to be connected
 * to IC3.
  *     @arg TIM_ICSelection_TRC: TIM Input 4 is selected to be connected to
 * TRC.
  * @param  TIM_ICFilter: Specifies the Input Capture Filter.
  *   This parameter must be a value between 0x00 and 0x0F.
  * @retval None
