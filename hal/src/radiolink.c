...
static struct crtpLinkOperations radioOp = { .setEnable = setEnable,
...
bool radiolinkTest() { return nrfTest(); }

struct crtpLinkOperations *radiolinkGetLink() { return &radioOp; }
