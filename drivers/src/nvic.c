...
void nvicInit(void) { NVIC_PriorityGroupConfig(NVIC_PriorityGroup_4); }
...
void DONT_DISCARD DMA1_Channel1_IRQHandler(void) { adcInterruptHandler(); }
...
void DONT_DISCARD EXTI9_5_IRQHandler(void) { extiInterruptHandler(); }
...
void DONT_DISCARD I2C1_ER_IRQHandler(void) { i2cErrorInterruptHandlerI2c1(); }

void DONT_DISCARD I2C2_EV_IRQHandler(void) {}

void DONT_DISCARD I2C2_ER_IRQHandler(void) { I2C_ClearFlag(I2C2, 0x1000FFFF); }
